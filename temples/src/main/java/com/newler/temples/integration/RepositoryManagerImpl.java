 ...
 */
package com.newler.temples.integration;
 ...
 *
 * @see <a href="https://github.com/JessYanCoding/MVPArms/wiki#2.3">RepositoryManagerImpl wiki 官方文档</a>
...
public class RepositoryManagerImpl implements RepositoryManager {
    ...
    @Inject
    public RepositoryManagerImpl(Lazy<Retrofit> retrofit, Lazy<RxCache> rxCache, Application application
